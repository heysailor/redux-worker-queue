        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function flush(item) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    console && console.log
                        ? console.log(`${flushId}:${item.createdAt}|flushWorker fired at ${new Date().toJSON()}`)
                        : null;
                    const result = yield flaggedWorker(item, flushId);
                    console && console.log
                        ? console.log(`${flushId}:${item.createdAt}|flushWorker finished at ${new Date().toJSON()}`)
                        : null;
            ...
            function flaggedWorker(queueItem, flushId) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    console && console.log
                        ? console.log(`[${flushId}:${result.item.clientMutationId}]flaggedWorker: Done, outcome flag is ${newFlag ? newFlag.status : null}`)
                        : null;
                    return true;
                });
            }
