        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (console && console.error) {
                    console.error(`Your handler for queued item with clientMutationId ${this.item.clientMutationId} of type ${this.item.type} returned an error, which is bad. The error was`, e);
                }
