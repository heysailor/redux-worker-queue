...
const duck_3 = require("./flush/duck");
const duck_4 = require("./flag/duck");
...
class WorkerQueue {
    ...
    flush() {
        store_1.store.dispatch(this.actions.flushAsync());
    }
    clearQueue() {
