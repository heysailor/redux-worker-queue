...
exports.clean = function () {
    return function cleanAsync(dispatch, getState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const irrelevant = lodash_1.differenceBy(exports.flagsSelector(state, WorkerQueue_1.INSTANCE), duck_1.queueSelector(state, WorkerQueue_1.INSTANCE), item => item.clientMutationId);
