# Redux Worker WorkerQueue [![Build Status](https://travis-ci.org/heysailor/redux-worker-queue.svg?branch=master)] [![Coverage Status](https://coveralls.io/repos/github/heysailor/redux-worker-queue/badge.svg?branch=coordinator)](https://coveralls.io/github/heysailor/redux-worker-queue?branch=coordinator)(https://travis-ci.org/heysailor/redux-worker-queue)
